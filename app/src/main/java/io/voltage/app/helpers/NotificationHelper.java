...
public interface NotificationHelper {
    ...
    void addNewMessageNotification(final Context context, final Message message);
    void addMessageNotSentNotification(final Context context, final Message message);
    void addNewFriendNotification(final Context context, final User user);
